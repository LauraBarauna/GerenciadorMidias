...
public class GerenciadorMidia {
    ...
    /**
     * Construtor da classe GerenciadorMidia. Inicializa a lista de mídias, verifica se o diretório de dados existe e carrega todos os dados do disco.
     */
    ...
    /**
     * Insere uma nova mídia na lista em memória e persiste no seu arquivo individual.
     * * @param midia: O objeto Midia a ser incluído.
     * @return true se a inclusão foi bem-sucedida, false se o objeto Midia for nulo.
     */
     ...
     * @return true se a atualização foi bem-sucedida, false se a mídia não for encontrada ou for inválida.
     */
    public boolean atualizarMidia(Midia midiaAtualizada) {
        ...
        for (int i = 0; i < this.midias.size(); i++) {
            if (this.midias.get(i).getId() == midiaAtualizada.getId()) {
                ...
                // Sobrescreve o arquivo auxiliar.
